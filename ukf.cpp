...
void UKF::UpdateRadar(MeasurementPackage meas_package) {
  ...
  PredictMeasurement(&Zsig_pred, &z_pred, &S_pred);
...
void UKF::GenerateAugSigmaPoints(MatrixXd *Xsig_aug) {
...
void UKF::PredictMeasurement(MatrixXd *Zsig_pred, VectorXd *z_pred,
                                  MatrixXd *S_pred){
